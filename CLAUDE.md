...
| `override` | batch, bash, find, grep, ls, web | 0 | lite | Read files verbatim, run checks, explore codebase. Standalone tool — zero required fields. |
